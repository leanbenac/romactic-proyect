...
function initApp() {
    ...
    const FLOWER_CONFIGS = {
        rose: {
            ...
            body: 'Cada una de estas rosas representa un motivo para hacerte sonreír, MaLu. Eres la persona más increíble, apasionada y dulce que conozco. Gracias por llenar mis días de amor, risas y de esa hermosa luz que solo tú tienes. Te amo con todo mi corazón.',
            colors: [
        ...
        sakura: {
            ...
            body: 'Como las flores de cerezo en primavera, traes belleza, paz y renovación a mi vida, MaLu. Contemplar tu sonrisa es como ver florecer el jardín más hermoso del mundo. Eres mi momento favorito del día y mi tranquilidad absoluta.',
            colors: [
        ...
        sunflower: {
            ...
            body: 'Eres mi energía y mi alegría de todos los días, MaLu. Al igual que los girasoles buscan la luz del sol, mi corazón siempre te busca a ti para llenarse de felicidad. Gracias por ser tan brillante, alegre y por iluminar mi mundo entero.',
            colors: [
        ...
        daisy: {
            ...
            body: 'Tu dulzura, sencillez y alegría iluminan cada rincón de mi vida, MaLu. Las margaritas representan la pureza y los nuevos comienzos, y contigo cada día se siente como un nuevo y hermoso comienzo lleno de promesas y amor puro.',
            colors: [
